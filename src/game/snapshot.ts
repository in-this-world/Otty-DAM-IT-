...
export interface OttySnapshot {
  ...
  readonly hazards: {
    readonly eagle: { readonly phase: string; readonly x: number; readonly y: number } | null;
    readonly bear: { readonly phase: string; readonly x: number; readonly y: number } | null;
  } | null;
}
